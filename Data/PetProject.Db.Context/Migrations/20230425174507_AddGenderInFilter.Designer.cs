...
namespace PetProject.Db.Context.Migrations
{
    ...
    [Migration("20230425174507_AddGenderInFilter")]
    partial class AddGenderInFilter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetProject.Db.Entities.AdvertisementFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("DateLostEnd")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("DateLostStart")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int?>("Gender")
                        .HasColumnType("integer");

                    b.Property<int?>("IsWanted")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("advertisementfilter", (string)null);
                });
            ...
            modelBuilder.Entity("PetProject.Db.Entities.Advertisement", b =>
                {
                    ...
                    b.HasOne("PetProject.Db.Entities.PetFile", "Image")
                        .WithMany("Advertisements")
            ...
            modelBuilder.Entity("PetProject.Db.Entities.AdvertisementFilter", b =>
                {
                    b.HasOne("PetProject.Db.Entities.User.User", "User")
                        .WithOne("AdvertisementFilter")
                        .HasForeignKey("PetProject.Db.Entities.AdvertisementFilter", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetProject.Db.Entities.User.User", b =>
                {
                    b.Navigation("AdvertisementFilter")
                        .IsRequired();
